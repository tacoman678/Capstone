...
def result():
    ...
    amazon_data = formatAmazon(getAmazonTitle(soup_amazon), getAmazonPrice(
        soup_amazon), getAmazonImage(soup_amazon), getAmazonLinks(soup_amazon), int(numInput))
    ebay_data = formatEbay(getEbayTitle(soup_ebay), getEbayPrice(
        soup_ebay), getEbayImage(soup_ebay), getEbayLinks(soup_ebay), int(numInput))
